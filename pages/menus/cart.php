                ...
                <div class="cart__right">
                    ...
                    if ($cart_goods['cart_goods'] == '{}' || $cart_goods['cart_goods'] == '') {
                        ...
                        <div class="cart__empty">
                            ...
                            <a href="/sakura/index.php">Нажмите здесь</a>, чтобы продолжить покупки</p>
                        </div>';
                    }
                    else{
                        ...
                        foreach ($array_id as $elem){
                            ...
                            echo '
                                <div class="cart__goods-list">
                                    <img class="cart__good-image" onclick="location.href=`/sakura/assets/item_name.php?id='.$goods['id'].'`;" src="/sakura/img/goods/'.$goods["image"].'" alt="">
                                    <div class="cart__good-name" onclick="location.href=`/sakura/assets/item_name.php?id='.$goods['id'].'`;">'.$goods["description"].'</div>
                    ...
                    if (isset($_POST['get_order']) && isset($_COOKIE['password_cookie_token']) && !empty($array_id)) {
                        ...
                        global $setval;
                        $setval->SendMail($name, $array_id, $email);
